...
export type HRWorksWebhookEvent = 'person.created' | 'person.updated' | 'person.deleted' | 'organization_unit.created' | 'organization_unit.updated' | 'organization_unit.deleted';
...
//# sourceMappingURL=hrworks.types.d.ts.map