 ...
 */
export const generateLoremWords = (wordCount) => generateLorem('words', wordCount);
 ...
 */
export const generateLoremSentences = (sentenceCount) => generateLorem('sentences', sentenceCount);
 ...
 */
export const generateLoremParagraphs = (paragraphCount) => generateLorem('paragraphs', paragraphCount);
