...
export default function TwoFactorYubiKeyPage() {
      ...
      <Grid gap={{ xs: 'large', lg: 'extraLarge' }}>
        ...
        <GridItem>
          <Grid>
            ...
            {selection && (
              <GridItem>
                <Button fullWidth variant="subtle" size="large" onClick={backToSelection}>
                  {t('backToSelection')}
                </Button>
              </GridItem>
            )}
            <GridItem>
              <Button fullWidth variant="subtle" size="large" onClick={backToLogin}>
                {t('backToLogin')}
              </Button>
            </GridItem>
          </Grid>
